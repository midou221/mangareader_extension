...
# مصادر قارئ مانجا عربي

هذا المستودع يحتوي على قائمة مصادر عربية يمكن إضافتها إلى تطبيق قارئ مانجا عربي.

> دعم استيراد مصادر المستودع من رابط JSON متوفر بدءاً من الإصدار `2.0.7.2`. إذا كنت تستخدم إصداراً أقدم، حدّث التطبيق أولاً.
...
1. تأكد أن إصدار التطبيق `2.0.7.2` أو أحدث.
2. افتح تطبيق قارئ مانجا عربي.
3. ادخل إلى صفحة إدارة المصادر.
4. اضغط على زر إضافة مصدر.
5. الصق رابط ملف المصادر الخام. يجب أن ينتهي الرابط بـ `.json`:
...
6. اضغط حفظ.
7. سيقوم التطبيق بتحميل الملف، فحص المصادر المدعومة، ثم إضافتها إلى المصادر.
8. يمكن تحديث المصادر لاحقاً بالسحب للتحديث من صفحة المصادر.
...
- دعم هذا المستودع يبدأ من إصدار التطبيق `2.0.7.2`.
